...
namespace MFPE_CustomerApi.Repository
{
    public class CustomerRepository : IRepository<Customer>
    {
        ...
        public static List<Customer> ListCustomer = new List<Customer>()
        {
            ...
            new Customer {CustomerId = 1, Name = "Riya", Address = "Ballupur Road, Dehradun",  PANno = "DCRP124" , DOB = "1998-11-20 01:02:01 AM"},
            new Customer {CustomerId = 2, Name = "Reema", Address = "Vijay Colony, Delhi", PANno = "DCRP23456", DOB = "1999-11-10 02:02:01 AM"}
        };
        /// <summary>
